...
public class sCrypto_basic {
	...
	private void initialize() {
		...
		txtValue.setBounds(260, 90, 114, 19);
		frame.getContentPane().add(txtValue);
		txtValue.setColumns(10);
		
		txtQuantity = new JTextField();
		txtQuantity.setText("quantity");
		txtQuantity.setBounds(260, 135, 114, 19);
		frame.getContentPane().add(txtQuantity);
		txtQuantity.setColumns(10);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(260, 39, 114, 24);
		...
		btnBuy.setBounds(55, 180, 117, 25);
		...
		btnSell.setBounds(260, 180, 117, 25);
		frame.getContentPane().add(btnSell);
		
		JLabel lblCrypto = new JLabel("Crypto: ");
		lblCrypto.setBounds(55, 44, 70, 15);
		frame.getContentPane().add(lblCrypto);
		
		JLabel lblPrice = new JLabel("Price: ");
		lblPrice.setBounds(55, 92, 70, 15);
		frame.getContentPane().add(lblPrice);
		
		JLabel lblQuantity = new JLabel("Quantity");
		lblQuantity.setBounds(55, 137, 70, 15);
