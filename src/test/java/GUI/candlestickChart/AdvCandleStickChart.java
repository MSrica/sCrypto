...
public class AdvCandleStickChart extends Pane {
    ...
    private static double[][] data = new double[][]{};  //TODO: get data into this from candlestick stuff
...
//    };
    ...
    public AdvCandleStickChart(double[][] importData, double max, double min) {

        //need--> data, datetime, max and min

        // x-axis:
        final NumberAxis xAxis = new NumberAxis(0, 32, 1);  //this will be the goddamn datetime shit
        xAxis.setMinorTickCount(0);
        xAxis.setLabel("Day");

        // y-axis:
        final NumberAxis yAxis = new NumberAxis();  //this needs to be continuously changing like in the other chart
